...
class MyEditor implements ActionListener {
    ...
    MyEditor() {
        ...
        jsp.setBounds(50, 60, 570, 250);
        jsp1.setBounds(50, 350, 570, 250);
        jf.add(jsp);
        jf.add(jsp1);
        jbcompile = new JButton("Compile");
        jbrun = new JButton("Run");
        jbcompile.setBounds(100, 630, 80, 25);
        jbrun.setBounds(280, 630, 80, 25);
        jf.add(jl);
        jf.add(jtf);
        ...
        if (e.getSource() == jbcompile) {
            ...
            if (!jtf.getText().equals("")) {
                try {
                    ...
                    pw.println(s1);
                    pw.flush();
                    Process error = r.exec("C:\\Program Files\\Java\\jdk-18.0.2.1\\bin\\javac.exe -d . " + fname);
            ...
            try {
                ...
                Process p = r.exec("C:\\Program Files\\Java\\jdk-18.0.2.1\\bin\\java " + fn);
